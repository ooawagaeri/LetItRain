...
public:
    ...
    void damage(WEAPON);
	virtual int getAttLevel()        { return attLevel; }
	virtual void setAttLevel(int a) { attLevel = a; }
	virtual int getSpeLevel()        { return speLevel; }
	virtual void setSpeLevel(int s) { speLevel = s; }
};
#endif
